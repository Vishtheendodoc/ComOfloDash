...
def inject_full_width_chart_css():
    ...
    <style>
        ...
        .lightweight-chart-container {width: 100% !important; height: 500px; border: 1px solid #e5e7eb; border-radius: 8px; margin: 20px 0;}
...
if mobile_view:
    ...
    if not agg_df.empty:
        ...
        stock_name = selected_option.split(' (')[0]  # ✅ Define it here again just before using
        st.download_button(
            "📥 Download Data",
            csv,
